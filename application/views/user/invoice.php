<div class="container" style="margin-top:65px">
	...
	<div class="card ">
      ...
      <!-- Judul Card -->
	  <div class="card-header"><b><strong>Invoice</strong></b></div>
	...
	<?php foreach($join_detail_transaksi as $invoice) : ?>
    <?php echo anchor('user/transaksi/transaksi_user/lihat/'. $invoice->id_transaksi, '<div class="btn btn-sm btn-primary">Kembali</div>') ?>
